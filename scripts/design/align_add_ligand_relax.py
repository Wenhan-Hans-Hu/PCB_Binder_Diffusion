...
####################
    ...
    for N in range(args.nstruct):
        ...
        # Heme models only:
        #I have some concerns that this is really being applied to "Heme models only", so I've taken the liberty of knocking out this if statement on a more permanent basis. UPDATE: restored during bugfixing, I fear a horrible mistake.
